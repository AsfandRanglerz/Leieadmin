                        ...
                        <div class="form-group">
                            ...
                            <div class="w-100 btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="py-3 btn active">
                                    <input type="radio" value="with end date" name="agreement" id="endTimed" autocomplete="off" checked/>
                                ...
                                <label class="py-3 btn">
                                    <input type="radio" value="without end date" name="agreement" id="endIndefinite" autocomplete="off"/>
                            ...
                            <div class="mt-3 hidden-info">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" value="1" class="custom-control-input" id="internetIncl1"/>
                    ...
                    <section class="mt-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input id="rentPerMonth" type="number" placeholder="Rent"
                                           class="form-control"/>
                                    <div class="input-group-append">
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-100 btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="py-3 btn active">
                                    <input type="radio" value="By moving date" name="rent_due" autocomplete="off" value="" id="movDatingInput"
                                           checked/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-100 btn-group btn-group-toggle" data-toggle="buttons">
                                ...
                                <label class="py-3 btn">
                                    <input type="radio" name="lease_security"  value="Other security"  autocomplete="off" id="leaseOtherSecurity"
                                           value="25-10-2011"/>
                                ...
                                <label class="py-3 btn" data-toggle="modal" data-target="#noSecurityModel">
                                    <input type="radio" name="lease_security" value="No security" autocomplete="off" id="leaseNoSecurity"
                                          />
...
{{--                            </select>--}}
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                ...
                                <input id="firstNameTenant" type="text" class="form-control" placeholder="First name of tenant"/>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input id="surnameTenant" type="text" class="form-control" placeholder="Surname of tenant"/>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input id="emailTenant" type="email " class="form-control" placeholder="example@gmail.com"/>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-8">
                                        <input id="phoneTenant" type="tel" placeholder="Mobile Number" class="form-control">
                            ...
                            <div class="text-center col-lg-10 mx-auto mb-4 light-box-shadow check-tenant-pay-remarks-container">
                                ...
                                <div class="mt-3 col-md-5 col-sm-7 col-12 btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="py-2 btn active">
                                        <input type="radio" name="tenant_remarks" autocomplete="off" value="Yes please!" checked />
                                        <span class="d-block text-center text">Yes please!</span>
                                        <span class="text-center fa fa-check check-mark"></span>
                                    </label>
                                    <label class="py-2 btn">
                                        <input type="radio" name="tenant_remarks" autocomplete="off" value="No thanks"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch">
                                    <input value="1" type="checkbox" class="custom-control-input" id="preManageFree">
                    ...
                    <section class="mt-4">
                        ...
                        <div class="my-xl-5 mt-4 text-center">
                            <a role="button" class="slide-arrow prev-arrow btn btn-bg-white"><span class="fa fa-arrow-left mr-2"></span>Last Page</a>
                            <a role="button" class="slide-arrow next-arrow ml-2 btn btn-bg">Next Page<span class="fa fa-arrow-right ml-2"></span></a>
                        </div>
                    </section>
                    <h6>Finished</h6>
                    <section class="mt-4">
                ...
                onStepChanged: function (event, currentIndex, priorIndex) {
                    ...
                    if (currentIndex == 1) {
                        ...
                        $.ajax({
                            ...
                            type: 'post',
                            data: { 'property_id':property_id,'rental_object_id':rental_object_id,'step':step,'language':language },
                    ...
                    if (currentIndex == 4) {
                        ...
                        $.ajax({
                            url: '{{URL::to('/client/lease-step1')}}',
                            type: 'post',
                            data: { 'first_name':first_name,'surname':surname,'email':email,'phone':phone,'countryCode':countryCode,'step':step,'payment_remarks':payment_remarks,'think_about_collecting_rent':think_about_collecting_rent },
                            success: function(response)
                            {
                                $("#loader").fadeOut("slow");
                            }, error: function (request, status, error) {
                ...
                success: function(response)
                {
                   ...
                   let option_data="";
                    ...
                    response.data.forEach((data, index)=>{
                        ...
                        option_data+='<option  value="'+data.id+'">'+data.street_name+'</option>';
                    })
            ...
            $.ajax({
                ...
                success: function(request)
                {
                    ...
                    request.data.forEach((data, index)=>{
                        ...
                        option_data+='<option  value="'+data.id+'">'+data.account+'</option>';
                    })
            ...
            $.ajax({
                ...
                success: function(response)
                {
                   ...
                   let option_data='';
                    option_data+='<option  value=""></option>';
                    response.data.forEach((data, index)=>{
                        option_data+='<option  value="'+data.id+'">'+data.rental_object+'</option>';
                    })
