...
@section('content')
    <div class="property-pg create-lease-pg">
        <h4>Edit lease</h4>
        <input value="{{$data_lease->id}}" type="hidden" name="id" id="lease_id">
        @if (isset($data_lease->tenant))
            <input  value="{{$data_lease->tenant->id}}" class="tenant_id" type="hidden" >
            @else
            <input  value="" type="hidden"  class="tenant_id">
        @endif
                ...
                <span id="createLeaseForm"  class="tab-wizard wizard-circle wizard clearfix">
                    ...
                    <section class="mt-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control single-select-dropdown" id="selProp">
                                    ...
                                    @forelse($property_data as $data)
                                        <option @if($data_lease->property_id==$data->id) selected @endif value="{{$data->id}}">{{$data->street_name}}</option>
                                    @empty
                                    @endforelse
                                </select>
                            ...
                            <div class="form-group col-md-6 d-none sel-prop-fields">
                                ...
                                <select class="form-control single-select-dropdown" id="selRentObj">
                                    ...
                                    @forelse($data_rebtal as $object)
                                        <option @if ($data_lease->rental_object_id==$object->id)
                                            selected
                                        @endif value="{{$object->id}}">{{$object->rental_object}}</option>
                                        @empty
                                    @endforelse
                                ...
                                <div class="my-3">
                                    <a class="btn btn-bg-white" data-toggle="modal"
                                       data-target="#createRentObjModal"><span
                        ...
                        <div class="mt-md-4 d-none sel-prop-fields">
                            <a class="d-flex align-items-center justify-content-between font-weight-bold text-decoration-none more-info-btn">Property<span
                                    class="fa fa-angle-up ml-2"></span></a>
                            <div class="mt-3 show-info">
                                <div class="form-group">
                                    <label>Street name</label>
                                    <input type="text" id="lease_street_name" placeholder="Street name" class="form-control" disabled/>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <label>House number</label>
                                        <input type="text" id="lease_house_number" placeholder="House number" class="form-control" disabled/>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>ZIP code</label>
                                        <input type="number" id="lease_zip_code" placeholder="ZIP code" class="form-control" disabled/>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <label>City</label>
                                        <input type="text" id="lease_city" placeholder="City" class="form-control" disabled/>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label>Commune</label>
                                        <input type="text" id="lease_commune" placeholder="Commune" class="form-control" disabled/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mt-md-4 d-none sel-rent-obj-fields">
                            <a class="d-flex align-items-center justify-content-between font-weight-bold text-decoration-none more-info-btn">Rental
                                Object<span class="fa fa-angle-up ml-2"></span></a>
                            <div class="mt-3 show-info">
                                <div class="form-row">
                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">
                                        <label>Housing type</label>
                                        <input type="text" id="lease_house" placeholder="Housing type" class="form-control"/>
                                    </div>
                                    <div class="form-group col-lg-6 d-none dorm-fields">
                                        <label>Apartment number</label>
                                        <input id="lease_appartment_number" type="text" placeholder="" class="form-control"/>
                                    </div>
                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">
                                        <label>Property number</label>
                                        <input type="text" id="lease_property_number" placeholder="" class="form-control"/>
                                    </div>
                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">
                                    ...
                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">
                                        ...
                                        <input id="lease_cable" type="text" placeholder="Cable TV" class="form-control"/>
                                    </div>
                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">
                                        <label>Furnishing</label>
                                        <input id="lease_furnishing" type="text" placeholder="" class="form-control"/>
                                    </div>
                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">
                                        <label>Water and wastewater</label>
                                        <input id="lease_water_wastewater" type="text" placeholder="" class="form-control"/>
                                    </div>
                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">
                                        <label>Smoking</label>
                                    ...
                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">
                                        ...
                                        <input id="lease_total_rooms" type="number" placeholder="" class="form-control"/>
                                    </div>
                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">
                                        <label>Number of bedrooms</label>
                                        <input id="lease_number_of_bathrooms" type="number" placeholder="" class="form-control"/>
                                    </div>
{{--                                    <div class="form-group col-lg-6 d-none sel-rent-obj-fields">--}}
                                ...
                                <div class="mt-3">
                                    <a class="btn btn-bg-white" data-toggle="modal"
                                       data-target="#editRentalObjModal"><span
                                            class="fa fa-edit mr-2"></span>Edit rental property</a>
                    ...
                    <section class="mt-4">
                        ...
                        <div class="form-group">
                            <label for="applyLease">With reference to the Rent Act, please select what applies to
                                this
                                lease <span class="required">*</span> <sup
                                    class="fa fa-question label-fa-question" data-toggle="tooltip"
                                    data-placement="top"
                            ...
                            <select class="form-control" id="applyLease">
                                <option @if ($data_lease->rental_act=="House or apartment (most common)")
                                    selected
                                @endif value="House or apartment (most common)">House or apartment (most common)
                                </option>
                                <option @if ($data_lease->rental_act=="Attic or basement dwelling in a detached house or dwelling in a semi-detached house where the landlord lives in the same house")
                                        selected
                                        @endif
                                ...
                                <option @if ($data_lease->rental_act=="A simple living space where the tenant has access to someone else's home")
                                        selected
                                        @endif
                                    value="A simple living space where the tenant has access to someone else's home">A
                                    simple living space where the tenant has access to someone else's home
                                </option>
                                <option @if ($data_lease->rental_act=="Housing that the landlord himself has used as his own home, and which is rented out as a result of temporary absence of up to five years")
                                        selected
                                        @endif
                                ...
                                <option @if ($data_lease->rental_act=="Warehouse / other premises")
                                        selected
                                        @endif value="Warehouse / other premises">Warehouse / other premises</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-100 btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="py-3 btn active">
                                    <input @if ($data_lease->agreement_type=="with end date")
                                        checked
                                    @endif type="radio" value="with end date" name="agreement" id="endTimed" autocomplete="off" />
                                ...
                                <label class="py-3 btn">
                                    <input @if ($data_lease->agreement_type=="without end date")
                                           checked
                                           @endif type="radio" value="without end date" name="agreement" id="endIndefinite" autocomplete="off"/>
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                <a class="d-flex align-items-center justify-content-between font-weight-bold text-decoration-none more-info-btn">Read
                                    more about Fixed-term agreement<span
                                        class="fa fa-angle-down ml-2"></span></a>
                            ...
                            <div class="form-group col-lg-6">
                                <a class="d-flex align-items-center justify-content-between font-weight-bold text-decoration-none more-info-btn">Read
                                    more about Indefinite agreement<span
                                        class="fa fa-angle-down ml-2"></span></a>
                                <div class="hidden-info">
                                    <ul class="pl-3">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input value="{{$data_lease->start_date_of_agreement}}" type="text" name="datePicker" placeholder="dd.mm.yyyy"
                            ...
                            <div class="form-group col-lg-6">
                                <label>End date of the agreement <span class="required">*</span></label>
                                <div class="input-group">
                                    <input value="{{$data_lease->end_date_of_agreement}}" type="text" name="datePicker" placeholder="dd.mm.yyyy"
                            ...
                            <div class="form-group col-12">
                                ...
                                <select class="form-control" id="specRentalPer">
                                    <option value=""></option>
                                    <option @if ($data_lease->rental_peroid=="At the end of the rental period, the housing space shall be used as housing by the landlord himself or others who belong to the landlord's household.")
                                       selected
                                    @endif
                                    ...
                                    <option @if ($data_lease->rental_peroid=="The rental unit is an attic or basement dwelling or dwelling in a semi-detached dwelling where the landlord lives in the same house.")
                                            selected
                                            @endif
                                    ...
                                    <option @if ($data_lease->rental_peroid=="The landlord has other objective reasons for the time limit")
                                            selected
                                            @endif value="The landlord has other objective reasons for the time limit">The
                                        landlord has other objective reasons for the time limit
                                    </option>
                                </select>
                            </div>
                            <div class="form-group col-12 d-none landlord-obj-time-fields">
                                <label>Please specify objective reason for the time limit <span
                                        class="required">*</span> <sup
                                        class="fa fa-question label-fa-question" data-toggle="tooltip"
                                        data-placement="top"
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                <label for="bindTime">Binding time <sup
                                        class="fa fa-question label-fa-question" data-toggle="tooltip"
                                        data-placement="top"
                                ...
                                <select class="form-control" id="bindTime">
                                    <option value=""></option>
                                    <option @if($data_lease->binding_peroid=="No time restraint") selected @endif value="No time restraint">No time restraint</option>
                                    <option @if($data_lease->binding_peroid=="1 months") selected @endif value="1 months">1 months</option>
                                    <option @if($data_lease->binding_peroid=="3 months") selected @endif value="3 months">3 months</option>
                                    <option @if($data_lease->binding_peroid=="6 months") selected @endif value="6 months">6 months</option>
                                    <option @if($data_lease->binding_peroid=="9 months") selected @endif value="9 months">9 months</option>
                                    <option @if($data_lease->binding_peroid=="12 months") selected @endif value="12 months">12 months</option>
                                </select>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="noticePer">Notice period <sup
                                        class="fa fa-question label-fa-question" data-toggle="tooltip"
                                        data-placement="top"
                                ...
                                <select class="form-control" id="noticePer">
                                    <option value=""></option>
                                    <option @if($data_lease->notice_peroid=="No time restraint") selected @endif value="No time restraint">No time restraint</option>
                                    <option @if($data_lease->notice_peroid=="1 month") selected @endif value="1 month">1 month</option>
                                    <option @if($data_lease->notice_peroid=="2 month") selected @endif value="2 months">2 months</option>
                                    <option @if($data_lease->notice_peroid=="3 months") selected @endif value="3 months">3 months</option>
                                    <option @if($data_lease->notice_peroid=="4 months") selected @endif value="4 months">4 months</option>
                                    <option @if($data_lease->notice_peroid=="5 months") selected @endif value="5 months">5 months</option>
                                    <option @if($data_lease->notice_peroid=="5 months") selected @endif value="6 months">6 months</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="mt-3 hidden-info">
                                <div class="form-group">
                                    ...
                                    <textarea id="houserRuleId" placeholder="House Rules" class="form-control">{{$data_lease->house_role}}</textarea>
                                    <small>If there are special house rules for this object, these can be specified
                                        here</small>
                                </div>
                                <div class="form-group">
                                    <label>Special terms</label>
                                    <textarea id="specialTerm" placeholder="Special terms" class="form-control">{{$data_lease->special_term}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input @if($data_lease->rent_out_as=="1") echecked @endif type="checkbox" value="1" class="custom-control-input" id="internetIncl1"/>
                    ...
                    <section class="mt-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input value="{{$data_lease->rent_per_month}}" id="rentPerMonth" type="number" placeholder="Rent"
                                           class="form-control"/>
                                    <div class="input-group-append">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select id="accRent" class="form-control">
                                    ...
                                    @forelse($account_data as $accountData)
                                        <option @if ($data_lease->account_id==$accountData->id)
                                            selected
                                        @endif value="{{$accountData->id}}">{{$accountData->account}}</option>
                                    @empty
                                    @endforelse
                                </select>
                                <span  id="accRentErr" ></span>
                                <a class="mt-3 btn btn-bg-white" data-toggle="modal"
                                   data-target="#addAccountModal"><span
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="rounded p-3 light-box-shadow">
                                                    <div class="form-group">
                                                        <label>Account number (11 digits) <span class="required">*</span> <sup
                                                                class="fa fa-question label-fa-question"
                                                                data-toggle="tooltip"
                                                                data-placement="top"
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="account" type="number" placeholder="Enter bank account"
                                                                   class="form-control"/>
                        ...
                        <div class="form-group">
                            ...
                            <select id="dueDate" class="form-control">
                                <option value=""></option>
                                <option @if ($data_lease->due_date=="The 1st current month")

                                @endif value="The 1st current month">The 1st current month</option>
                                <option @if ($data_lease->due_date=="The 5th of the current month")

                                        @endif value="The 5th of the current month">The 5th of the current month</option>
                                <option @if ($data_lease->due_date=="The 10th of the current month")

                                        @endif value="The 10th of the current month">The 10th of the current month</option>
                                <option @if ($data_lease->due_date=="The 15th of the current month")

                                        @endif value="The 15th of the current month">The 15th of the current month</option>
                                <option @if ($data_lease->due_date=="The 20th of the current month")

                                        @endif value="The 20th of the current month">The 20th of the current month</option>
                                <option @if ($data_lease->due_date=="The 25th of the current month")

                                        @endif value="The 25th of the current month">The 25th of the current month</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="w-100 btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="py-3 btn active">
                                    <input @if ($data_lease->rent_due=="By moving date")
                                        checked
                                    @endif type="radio" value="By moving date" name="rent_due" autocomplete="off" value="" id="movDatingInput"
                                           />
                                ...
                                <label class="py-3 btn">
                                    <input @if ($data_lease->rent_due=="By due date")

                                           @endif type="radio" name="rent_due" autocomplete="off" value="By due date"
                                           id="byDueDate"/>
                        ...
                        <div class="form-group">
                            <h6>Payment of first rent <sup class="fa fa-question label-fa-question"
                                                           data-toggle="tooltip"
                                                           data-placement="top"
                            ...
                            <div class="custom-control custom-radio">
                                <input @if ($data_lease->payment_for_first_rent=='1')
                                    checked
                                @endif type="radio" id="firstRentFullMonth" value="1" name="payment_first_rent"
                            ...
                            <div class="row mx-0 my-2 d-none info-container first-rent-full-month-radio">
                                <div class="col-md-11 px-0 order-md-1 order-2">
                                    <ul class="pl-3 mb-0">
                                        <li>Rent October: NOK 25,041 due 25.10.2021 <span class="d-none by-due-date">(By due date)</span>
                                        </li>
                            ...
                            <div class="custom-control custom-radio">
                                <input @if ($data_lease->payment_for_first_rent=='2')
                                       checked
                                       @endif type="radio" id="firstRentEntMonth" value="2" name="payment_first_rent"
                                       class="custom-control-input"/>
                            ...
                            <div class="custom-control custom-radio">
                                <input @if ($data_lease->payment_for_first_rent=='3')
                                       checked
                                       @endif type="radio" id="customFirstRent" value="3" name="payment_first_rent"
                                       class="custom-control-input"/>
                            ...
                            <div class="row mx-0 my-2 d-none info-container custom-first-rent-radio">
                                <div class="col-md-11 px-0 order-md-1 order-2">
                                    <ul class="pl-3 mb-0">
                                        <li>Rent October: NOK 0 due 25.10.2021 <span class="d-none by-due-date">(By due date)</span>
                                        </li>
                                        <li>Rent November: NOK 32,345 due 25.11.2021 (By due date)</li>
                                    </ul>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-100 btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="py-3 btn active">
                                    <input type="radio" value="Deposit account in another bank" name="lease_security" autocomplete="off"
                                           id="leaseDepositAccount" checked/>
                                    <span class="d-block text-center text">Deposit account in another bank</span>
                                    <span class="text-center fa fa-check check-mark"></span>
                                </label>
                                <label class="py-3 btn">
                                    <input @if ($data_lease->lease_security=="Other security")
                                        checked
                                    @endif type="radio" name="lease_security"  value="Other security"  autocomplete="off" id="leaseOtherSecurity"
                                           value="25-10-2011"/>
                                ...
                                <label class="py-3 btn" data-toggle="modal" data-target="#noSecurityModel">
                                    <input @if ($data_lease->lease_security=="No security")
                                           checked
                                           @endif type="radio" name="lease_security" value="No security" autocomplete="off" id="leaseNoSecurity"
                                    />
                        ...
                        <div class="form-row d-none lease-deposit-account-checkbox">
                            ...
                            <div class="form-group col-lg-6 mb-2 d-none choose-deposit-amount-checkbox">
                                <label>Custom deposit amount <sup
                                        class="fa fa-question label-fa-question" data-toggle="tooltip"
                                        data-placement="top"
                                        title="Please enter the sum for the deposit. This must be a maximum of 6 months rent"></sup></label>
                                <div class="input-group">
                                    <input value="{{$data_lease->custom_deposit_amount}}"  id="customDepositAmount" type="number" placeholder="Ex: 30000"
                                           class="form-control"/>
                                    <div class="input-group-append">
                                        <small class="input-group-text text-uppercase">Enough</small>
                                    </div>
                        ...
                        <div class="form-group mb-2 d-none lease-deposit-account-checkbox do-not-have-account-checkbox">
                            ...
                            <select id="accDeposit" class="form-control">
                                <option value=""></option>
                                 @forelse($account_data as $accountData)
                                    <option @if($data_lease->deposit_account==$accountData->id) selected @endif value="{{$accountData->id}}">{{$accountData->account}}</option>
                                @empty
                                @endforelse
                            </select>
...
{{--                            <a class="mt-2 btn btn-bg-white" data-toggle="modal"--}}
                        ...
                        <div class="form-group d-none lease-deposit-account-checkbox">
                            <div class="custom-control custom-checkbox">
                                <input @if($data_lease->no_account=='1') selected @endif value="1" type="checkbox" class="custom-control-input" id="notAccountNo"/>
                        ...
                        <div class="form-group d-none lease-deposit-account-checkbox">
                            ...
                            <div class="custom-control custom-switch">
                                <input @if($data_lease->altDeposit=='1') checked @endif value="1" type="checkbox" class="custom-control-input" id="altDeposit"/>
                        ...
                        <div class="form-row d-none deposit-account-guarantee-checkbox">
                            ...
                            <div class="form-group col-12">
                                <label>Warranty issuer <sup class="fa fa-question label-fa-question"
...
{{--                            <select id="Street_numberReadOnly" class="form-control single-select-dropdown" id="strNumber" disabled>--}}
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                <label>First name of tenant <span class="required">*</span> <sup
                                        class="fa fa-question label-fa-question" data-toggle="tooltip"
                                        data-placement="top"
                                        title="Here you write the tenant's first name"></sup></label>
                                <input value="{{isset($data_lease->tenant)?$data_lease->tenant->first_name:''}}" id="firstNameTenant" type="text" class="form-control" placeholder="First name of tenant"/>
                            ...
                            <div class="form-group col-lg-6">
                                <label>Surname of tenant <span class="required">*</span> <sup
                                        class="fa fa-question label-fa-question" data-toggle="tooltip"
                                        data-placement="top"
                                        title="Here you write the tenant's last name"></sup></label>
                                <input value="{{isset($data_lease->tenant)?$data_lease->tenant->surname:''}}" id="surnameTenant" type="text" class="form-control" placeholder="Surname of tenant"/>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input value="{{isset($data_lease->tenant)?$data_lease->tenant->email:''}}" id="emailTenant" type="email " class="form-control" placeholder="example@gmail.com"/>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="form-row">
                                   @if(isset($data_lease->tenant->phone))
                                    @php

                                        $phoneArray = explode(",", $data_lease->tenant->phone);

                                    @endphp
                                    <div class="col-4">
                                        <select class="form-control" id="dialCode">

	                                        <option @if ($phoneArray[0]=='+1')selected @endif value="+1">+1</option>
                                            <option @if ($phoneArray[0]=='+91') selected @endif value="+91">+91</option>
                                            <option @if ($phoneArray[0]=='+92') selected @endif value="+92">+92</option>
                                            <option @if ($phoneArray[0]=='+93') selected @endif value="+93">+93</option>
                                            <option @if ($phoneArray[0]=='+47') selected @endif value="+47">+47</option>
                                    ...
                                    @endif
                                    <div class="col-8">
                                        <input value="{{isset($data_lease->tenant)?$phoneArray[1]:''}}" id="phoneTenant" type="tel" placeholder="Mobile Number" class="form-control">
                            ...
                            <div class="text-center col-lg-10 mx-auto mb-4 light-box-shadow check-tenant-pay-remarks-container">
                                ...
                                <p>Secure yourself against bad payers by checking if your tenant has payment remarks
                                    ...
                                    check the tenant to get an insight into the tenant's ability to pay. <a
                                        href="#" data-toggle="modal" data-target="#creditCheckModal" class="font-weight-bold">read
                                ...
                                <div class="mt-3 col-md-5 col-sm-7 col-12 btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="py-2 btn active">
                                        <input @if($data_lease->payment_remarks=="Yes please!") checked @endif type="radio" name="tenant_remarks" autocomplete="off" value="Yes please!" checked />
                                        <span class="d-block text-center text">Yes please!</span>
                                        <span class="text-center fa fa-check check-mark"></span>
                                    </label>
                                    <label class="py-2 btn">
                                        <input @if($data_lease->payment_remarks=="tenant_remarks") checked @endif type="radio" name="tenant_remarks" autocomplete="off" value="No thanks"/>
                                ...
                                <div class="modal fade" id="creditCheckModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="rounded p-3 light-box-shadow">
                                                    <p>Poor payers are many landlords' cause of poor night's sleep, and are something that can be a very costly affair. If you credit check the tenant, you get very useful information about the tenant's ability to pay, and can eliminate a lot of uncertainty!</p>
                                                    <p>As a landlord, you have a valid reason to perform a credit check of the tenant, as long as it can be probable that you will be included in a lease agreement, and that the rent will be paid in full or in part in advance. Credit checks are carried out by Experian, and copy letters are sent to the tenant from Experian afterwards.</p>
                                                    <p class="font-italic mb-0">The service costs 69 kroner, and is provided by Experian.</p>
                                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch">
                                    <input @if($data_lease->think_about_collecting_rent=="1") checked @endif type="checkbox" class="custom-control-input" id="preManageFree">
                    ...
                    <section class="mt-4">
                        <div class="pdf-images">
                            <div>
                                <img src="{{asset('public/front_end/images/pdf-images/pdf1.png')}}" class="pdf-img"/>
                            </div>
                            <div>
                                <img src="{{asset('public/front_end/images/pdf-images/pdf1.png')}}" class="pdf-img"/>
                            </div>
                    ...
                    <section class="mt-4">
                        <div class="col-md-8 mx-auto">
                            ...
                            <p class="text-center">We are now sending an invitation to your tenant. When the tenant has signed, you will be notified, and you can also sign the lease.</p>
                        </div>
                    </section>
                </span>
            </div>
    ...
    <script>
            ...
            $("#createLeaseForm").steps({
                ...
                onStepChanged: function (event, currentIndex, priorIndex) {
                    ...
                    if (currentIndex == 1) {
                        ...
                        $.ajax({
                            url: '{{URL::to('/client/edit-lease-step1')}}',
                            type: 'post',
                            data: { 'id':id,'property_id':property_id,'rental_object_id':rental_object_id,'step':step,'language':language },
                    ...
                    if (currentIndex == 2) {
                        ...
                        $.ajax({
                            url: '{{URL::to('/client/edit-lease-step1')}}',
                            type: 'post',
                            data: { 'rental_act':rental_act,'agreement_type':agreement_type,'start_date_of_agreement':start_date_of_agreement,'end_date_of_agreement':end_date_of_agreement,'rental_peroid':rental_peroid,'binding_peroid':binding_peroid,'notice_peroid':notice_peroid,'house_rule':house_rule,'agreement_type':agreement_type,'special_term':special_term ,'special_term':rent_out_as,'step':step },
                            success: function(response)
                            {
                                $("#loader").fadeOut("slow");
                                ...
                                $('#startDateErr').text(errors['start_date_of_agreement'][0]);
                    ...
                    if(currentIndex==3){
                        ...
                        let payment_for_first_rent=$('input[name="payment_first_rent"]:checked').val();
                        ...
                        $.ajax({
                            url: '{{URL::to('/client/edit-lease-step1')}}',
                            type: 'post',
                            data: {'rent_per_month':rent_per_month,'account_id':account_id,'dueDate':dueDate,'rent_due':rent_due,'payment_for_first_rent':payment_for_first_rent,'lease_security':lease_security,'number_of_months_deposit':number_of_months_deposit,'custom_deposit_amount':custom_deposit_amount,'deposit_account':deposit_account,'no_account':no_account ,'altDeposit':altDeposit,'step':step },
                            success: function(response)
                            {
                    ...
                    if (currentIndex == 4) {
                        ...
                        $.ajax({
                            url: '{{URL::to('/client/edit-lease-step1')}}',
                            type: 'post',
                            data: {'tenant_id':tenant_id, 'first_name':first_name,'surname':surname,'email':email,'phone':phone,'countryCode':countryCode,'step':step,'payment_remarks':payment_remarks,'think_about_collecting_rent':think_about_collecting_rent },
                            success: function(response)
                            {
                                $("#loader").fadeOut("slow");
        ...
        function submitRecord()
        {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {'rental_object':rental_object,'property_id':property_id, 'property_number':property_number,'appartment_number':appartment_number,'room_and_other':room_and_other,'Bid_number':Bid_number,'size_useable_area':size_useable_area,'number_of_parking_other':number_of_parking_other,'number_of_keys_in_parking_space':number_of_keys_in_parking_space,'number_of_parking':number_of_parking,'number_of_bathrooms':number_of_bathrooms,'number_of_bedrooms':number_of_bedrooms ,'number_of_kitchen':number_of_kitchen,'number_of_stalls':number_of_stalls,'share_bethroom_people':share_bethroom_people,'share_kitchen_people':share_kitchen_people,'share_living_room_common_area_people':share_living_room_common_area_people,'size_m2_room':size_m2_room,'story':story,'total_rooms':total_rooms,'internet':internet,'cable':cable,'smoking':smoking,'pets':pets,'house_role':house_role,'furnishing':furnishing,'electricity_heating':electricity_heating,'water_wastewater':water_wastewater,'name':name,'description':description,'number_of_remotes':number_of_remotes,'number':number },
                success: function(response)
                {
