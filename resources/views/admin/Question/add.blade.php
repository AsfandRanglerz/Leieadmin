                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            <div class="col-12 form-group">
                                <label>Title</label>
                                <textarea name="question" class="form-control" rows="3" placeholder="Enter ..." required></textarea>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 form-group">
                                ...
                                <textarea name="answer" class="form-control" rows="3" placeholder="Enter ..." required></textarea>
