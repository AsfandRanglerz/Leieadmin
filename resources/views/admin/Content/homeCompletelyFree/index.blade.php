                        ...
                        <div class="col-sm-12">
                            <table class="display table table-striped table-bordered dataTable text-center"
                                ...
                                <tr>
                                    ...
                                    <td> @if($data->image) <img src="{{asset('public/uploads/'.$data->image)}}"  height="60px" width="90px" class="elevation-2" alt="Profession Image">@else N/A @endif</td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start">
                                            <a class="dropdown-item" href="{{route('section.edit',$data->id)}}">
